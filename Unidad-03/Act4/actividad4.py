...
def tarea2():
    ...
    try:
        with db.atomic():  # Iniciar una transacción para la operación de eliminación
            ...
            # Mostrar los juguetes restantes para verificar
...
def tarea3():
    ...
    try:
        with db.atomic():  # Iniciar una transacción para eliminar varios registros
